...
module.exports = class BotInfoCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['bot', 'bi'],
      usage: 'botinfo',
      description: 'Fetches AlanBot\'s bot information.',
  ...
  run(message) {
    ...
    const embed = new MessageEmbed()
      .setTitle('AlanBot\'s Bot Information')
      .setDescription(oneLine`
        AlanBot is an open source, fully customizable Discord bot that is constantly growing.
