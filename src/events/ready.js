module.exports = async (client) => {
  ...
  for (const guild of leftGuilds) {
    ...
    client.logger.info(`AlanBot has left ${guild.guild_name}`);
  }

  client.logger.info('AlanBot is now online');
  client.logger.info(`AlanBot is running on ${client.guilds.cache.size} server(s)`);
};
